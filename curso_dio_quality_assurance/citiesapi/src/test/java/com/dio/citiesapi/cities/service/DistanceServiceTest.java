package com.dio.citiesapi.cities.service;
...
class DistanceServiceTest {
  ...
  private City taubatinga;

  @BeforeEach
  public void setUp() {
    taubatinga = new City(4929L, "Taubatinga", 26, 3519303, "(-21.95840072631836,-47.98820114135742)",
  ...
  public void shouldCalculateInMetersUsingMath() {
    given(cityRepository.findAllById(anyList())).willReturn(Arrays.asList(taubatinga, saoCarlos));
